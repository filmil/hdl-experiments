...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_elamre_vcd",
        importpath = "github.com/elamre/vcd",
        sum = "h1:A7q40eTMWHkN8hWwF5I/u03Lc/XcpJBZRe/YTVRRvqo=",
        version = "v0.1.3",
    )
    go_repository(
        name = "com_github_filmil_go_vcd_parser",
        importpath = "github.com/filmil/go-vcd-parser",
        sum = "h1:foH9MIcmLWmAMjpIaKrvWSDVEnFHdDtc2nMuw3weE6E=",
        version = "v0.0.0-20241228070253-f78e71ef9f75",
    )
    go_repository(
